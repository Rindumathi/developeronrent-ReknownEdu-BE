...
router.put('/probabilitytool', (req, res, next) => {
    ...
    MongoClient.connect(url, function (err, db) {
        ...
        if ((req.body.pg_gre >= 330 && req.body.pg_gre <= 340) && (req.body.pg_gmat >= 740 && req.body.pg_gmat <= 800) && (req.body.pg_sat >= 1500 && req.body.pg_sat <= 1600) && (req.body.pg_toefl >= 115 && req.body.pg_toefl <= 120) && (req.body.pg_ielts >= 8 && req.body.pg_ielts <= 9) && (req.body.pg_pte >= 80 && req.body.pg_pte <= 90) && req.body.pg_wrkexp == "6 Years" && req.body.pg_internship == "5 Certificates" && req.body.pg_projects == 6 && (req.body.pg_workshops == 3 || req.body.pg_workshops == 4) && req.body.pg_extraskills >= 15 && req.body.pg_sports >= 5 && req.body.pg_conference >= 5 && req.body.pg_paperpresentation >= 5 && req.body.pg_recommendation == "Exemplary" && req.body.pg_universityreputation == "Exemplary" && req.body.pg_patents >= 5 && req.body.pg_seminars >= 5 && req.body.pg_Backlogs == 0 && (req.body.pg_12th >= 9.5 && req.body.pg_12th <= 10) && (req.body.pg_10th >= 9.5 && req.body.pg_10th <= 10) && (req.body.pg_gpa >= 9.5 && req.body.pg_gpa <= 10)) {
            ...
            if ((req.body.pg_gre >= 325 && req.body.pg_gre <= 329) && (req.body.pg_gmat >= 680 && req.body.pg_gmat <= 739) && (req.body.pg_sat >= 1400 && req.body.pg_sat <= 1499) && (req.body.pg_toefl >= 110 && req.body.pg_toefl <= 114) && (req.body.pg_ielts >= 7.5 && req.body.pg_ielts <= 9) && (req.body.pg_pte >= 75 && req.body.pg_pte <= 79) && req.body.pg_wrkexp == "5 Years" && req.body.pg_internship == "4 Certificates" && req.body.pg_projects == 5 && (req.body.pg_workshops == 3 || req.body.pg_workshops == 4) && req.body.pg_sports >= 4 && req.body.pg_conference >= 4 && req.body.pg_paperpresentation >= 4 && req.body.pg_recommendation == "Amazing" && req.body.pg_universityreputation == "Amazing" && req.body.pg_patents >= 4 && req.body.pg_seminars >= 4 && (req.body.pg_12th >= 9 && req.body.pg_12th <= 9.4) && (req.body.pg_10th >= 9 && req.body.pg_10th <= 9.4) && (req.body.pg_gpa >= 8.5 && req.body.pg_gpa <= 9.4) && (req.body.pg_extraskills >= 12 && req.body.pg_extraskills <= 14) && (req.body.pg_Backlogs >= 1 && req.body.pg_Backlogs <= 3)) {
                ...
                if (req.body.pg_seminars >= 3 && req.body.pg_recommendation == "Superb" && req.body.pg_universityreputation == "Superb" && req.body.pg_patents >= 3 && req.body.pg_paperpresentation >= 3 && req.body.pg_conference >= 3 && req.body.pg_sports >= 3 && (req.body.pg_extraskills >= 10 && req.body.pg_extraskills <= 11) && (req.body.pg_workshops == 3 || req.body.pg_workshops == 4) && req.body.pg_projects == 4 && req.body.pg_internship == "3 Certificates" && req.body.pg_wrkexp == "4 Years" && (req.body.pg_gre >= 315 && req.body.pg_gre <= 324) && (req.body.pg_gmat >= 650 && req.body.pg_gmat <= 679) && (req.body.pg_sat >= 1300 && req.body.pg_sat <= 1399) && (req.body.pg_toefl >= 100 && req.body.pg_toefl <= 109) && (req.body.pg_ielts >= 7 && req.body.pg_ielts <= 9) && (req.body.pg_pte >= 70 && req.body.pg_pte <= 74) && (req.body.pg_Backlogs >= 4 && req.body.pg_Backlogs <= 6) && (req.body.pg_gpa >= 8 && req.body.pg_gpa <= 8.4) && (req.body.pg_12th >= 8.5 && req.body.pg_12th <= 8.9) && (req.body.pg_10th >= 8.5 && req.body.pg_10th <= 8.9)) {
